...
public class WrenchDoor : MonoBehaviour, IInteractable
{
    ...
    {
        if (GameManager.instance.hasWrench == true)
        {
    ...
    {
        if (PlayerController.instance.eyesOpen && GameManager.instance.hasWrench == false)
        {
        ...
        if (PlayerController.instance.eyesOpen && GameManager.instance.hasWrench == true)
        {
